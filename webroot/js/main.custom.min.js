...
function check_perform_sreturn(id)
{
    
    if(confirm("Do you want to return selected record"))
    {
        $(document).ready(function(){
...
function check_perform_return()
{
    var numberOfChecked = $('.chkselect:checked').length;
    if(numberOfChecked==0)
    bootbox.alert("Please Checked Any Record");
    else
    {
        if(confirm("Do You Want To Return " +numberOfChecked+" Record"))
        document.deleteallfrm.submit();
    }
}
